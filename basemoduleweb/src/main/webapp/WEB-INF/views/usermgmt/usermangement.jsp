			...
			<div class="">
				<div class="row">
					<div class="col-xs-12">
						...
						<div class="col-md-1">
							<h3 style="margin-top: 5px; text-align: center;">OR</h3>
						</div>
						<div class="col-md-4">
						...
						<div class="col-md-1">
							<button class="btn btn-default btn-flat" type="button"
								style="background-color: #0f3940; color: #ffffff; border-color: #0f3940;">
								Search</button>
						</div>
						<div class="col-md-2">
				...
				<section class="content" style="min-height:0px;padding-bottom:0px">
					...
					<p class="gdi-text">Lorem Ipsum</p>
					 ...
					 <a href="organizationprofile"><img src="dist/img/pencil.png"></a>
					 </div>
					 <div class="col-md-3">
