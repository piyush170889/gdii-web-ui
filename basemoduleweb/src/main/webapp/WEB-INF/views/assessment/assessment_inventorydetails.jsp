		...
		<div class="hgt_" style="min-height: 587px;">
			...
			<section class="content">
				<div class="row tec">
					...
					<div class="col-md-3">
						<a href="#"><img src="dist/img/addd.png" style="float: right;"></a>
					</div>
				</div>
				<div class="tec">
					...
					<div class="col-md-10">
					<p>http://lorem ipsum.ips</p>
					</div>
					
					<div class="col-md-5">
					<label>Shared Members:</label>
					</div>
					<div class="col-md-7">
					<p>400</p>				
					</div>
				...
				<div class="col-md-12">
					<table class="table table-striped">
						...
						<tbody>
							<tr>
								<td>Consecutor Amet</td>
								<td>20/05/2017</td>
								<td>2500</td>
								<td>2500</td>
								<td><a
									href="#" data-toggle="modal" data-target="#addmodal"><i class="fa fa-pencil" aria-hidden="true"
										style=""></i></a>  <a href="#"><i class="fa fa-ban"
								...
								<form role="form" action="" method="post">
									...
									<div class="box-body" style="color: #333;">
										<div class="row">
											...
											<div class="col-md-6">
												<div class="form-group">
													<input class="form-control" placeholder="" name="firstName"  value="2000"/>
												</div>
											</div>
										</div>
