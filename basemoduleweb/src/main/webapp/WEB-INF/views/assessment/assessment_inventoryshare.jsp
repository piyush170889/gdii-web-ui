...
<title>Assignment Inventory Share</title>
	...
	<div class="wrapper">
		...
		<div class="hgt_" style="min-height: 587px;">
			...
			<section class="content">
					...
					<table class="table table-striped">
						<thead style="background-color: #99999b;">
							<tr>
								...
								<label><input type="checkbox" value="" style="margin-top: 19px;"></label>
								</div></th>
								<th>Organization Name</th>
								<th>Parent Enterprises</th>
								<th>Business Unit</th>
								<th>Address</th>
							</tr>
						</thead>
						<tbody>
							<tr>
								...
								<td>Lorem Ipsum</td>
								<td>Lorem Ipsum</td>
								<td>Country,Territory,State,Pincode</td>
							</tr>
							<tr>
								<td><div class="checkbox">
								<label><input type="checkbox" value="" style="margin-top: -6px;"></label>
				...
				<button class="btn btn-default default">Share Selected</button>
				</div>
			</section>
